-- =====================================================
-- Alex AI - NUCLEAR CLEAN SLATE Migration
-- Version: 3.0.0 - BULLETPROOF
-- Date: 2025-12-26
-- Description: Complete database wipe and fresh install
-- =====================================================

-- =====================================================
-- STEP 1: NUCLEAR OPTION - Drop entire schema and recreate
-- =====================================================

-- This ensures EVERYTHING is gone, no matter what exists
...
BEGIN
  ...
  SELECT COUNT(*) INTO v_crew_count FROM crew_members;
  ...
  RAISE NOTICE '  - Crew members: %', v_crew_count;
  RAISE NOTICE '';
