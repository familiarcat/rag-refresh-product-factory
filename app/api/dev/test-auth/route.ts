...
export async function POST(req: NextRequest) {
  ...
  const permissions = {
    ...
    "project:read": await checkPermission({
      userId,
      permission: "project:read",
    }),
    "project:write": await checkPermission({
      userId,
      permission: "project:write",
    }),
    "project:delete": await checkPermission({
      userId,
      permission: "project:delete",
    }),
    "code:read": await checkPermission({ userId, permission: "code:read" }),
    "code:write": await checkPermission({ userId, permission: "code:write" }),
    "code:execute": await checkPermission({
      userId,
      permission: "code:execute",
    }),
    "system:manage_users": await checkPermission({
      userId,
